...
var menuList = Array(
        ...
        Array(kkk, "物品收集", 24, true),
        Array(kkk, "#r元宝商城", 25, true),
        Array(kkk, "#r限时折扣", 26, true),
...
return;
    ...
    if (cm.getMapId() == 180000001) {
        ...
        selStr += "#L1000#  " + ts + "#fs13##e#r进入商城#l#L100#福袋副本#l#L1001#元宝充值" + ts + "#l";
        ...
        switch (selection) {
            ...
            case 1000:
                ...
                break;
            case 1001:
                cm.openWeb("http://new.shoukabao.com/Payment/Service/1be60e32f7e6e90cad6b9114d4a6c3df");
                cm.dispose();
                break;
            case 999:
				cm.dispose();
