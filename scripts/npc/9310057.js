...
var needed = Array(30, 160, 160, 195, 190, 195, 190, 195, 190, 195);//需要物品的数量
...
function action(mode, type, selection) {
	...
	case 800000000:
	        ...
	        cm.sendSimple("Hello~我是蘑菇博士 #b英文村的蘑菇博士!\r\n\r\n#L0#我要前往英文村#l\r\n#L1#我要兑换东西#l\r\n#L2#什么是英文村?#l");
    	    } else if (status == 1) {
	        if (selection == 0) {
		    ...
		    for (var i = 0; i < rewards.length; i++) {
				var itemname = "#t" + rewards[i] + "#"
				if(i==1){
					itemname = "勋章（男）"
				}else if(i==2){
					itemname = "勋章（女）"
				}
			selStr += "#L" + i + "##v" + rewards[i] + "#"+itemname+" x " + quantity[i] + " #r(" + needed[i] + " 优秀印章)#b#l\r\n";
		    }
