...
function end(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.sendNextPrev("楓葉丘陵… 染紅的楓葉… 非常悲壯的的名字呀。", 2);
    } else if (status == 2) {
        qm.sendNextPrev("哈哈，這麼說好像也是。 先見見陣地內的毛利吧，也需要商量一下進後的事情…");
    } else if (status == 3) {
        qm.sendNextPrev("直江兼續您呢?", 2);
    } else if (status == 4) {
