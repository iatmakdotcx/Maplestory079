...
function start(mode, type, selection) {
	...
	qm.sendAcceptDecline("请带来 1歌 #b#t4032267##k 和 1个 #b#t4032268##k 。用这些道具我将送你一样礼物！");
    } else if (status == 5) {
	qm.forceStartQuest();
	qm.summonMsg(9);
	qm.dispose();
...
function end(mode, type, selection) {
	...
	qm.completeQuest();
	qm.completeQuest(20000);
	qm.completeQuest(20001);
	qm.completeQuest(20002);
	qm.completeQuest(20015);
	qm.gainExp(95);
	qm.summonMsg(10);
	qm.dispose();
    }
