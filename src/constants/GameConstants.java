...
public class GameConstants {
    ...
    private static final int[] ExpTable = {0, 15, 34, 57, 92, 135, 372, 560, 840, 1242, 1716,
            ...
            251068606, // 160
            264827165, 279339693, 294647508, 310794191, 327825712, 345790561, 364739883, 384727628, 405810702,
            428049128, // 170
            451506220, 476248760, 502347192, 529875818, 558913012, 589541445, 621848316, 655925603, 691870326,
            729784819,
    ...
    public static boolean isNoDelaySkill(int skillId) {
        return skillId == SkillType.格斗家.蓄能激发
                ...
                || skillId == 2111007 || skillId == 2211007 || skillId == 2311007 || skillId == 32121003
                || skillId == 35121005 || skillId == 35111004 || skillId == 35121013 || skillId == 35121003
                || skillId == 22150004 || skillId == 22181004 || skillId == 11101002 || skillId == 51100002
                || skillId == 13101002 || skillId == 24121000 || skillId == 112001008 || skillId == 22161005
                || skillId == 22161005;
    }
    ...
    private static double getAttackRangeByWeapon(MapleCharacter chr) {
        ...
        MapleWeaponType weapon = weapon_item == null ? MapleWeaponType.没有武器
