                ...
                for (MapleData life : mapData.getChildByPath("life")) {
                    ...
                    if ((npcs || !type.equals("n")) && !limited.equals("Stage0")) { // alien pq stuff
                        ...
                        if (myLife instanceof MapleMonster && !GameConstants.isNoSpawn(mapid)) {
                            ...
                            if (!CustomConstants.isNoSpawnNPC(myLife.getId())) {
            ...
            for (AbstractLoadedMapleLife n : custom) {
                if ("n".equals(n.getCType())) {
                    ...
                    if (npc == null) {
                        ...
                        npc.setRx1(n.getRx1());
                        npc.setFh(n.getFh());
                        npc.setHide(n.isHidden());
                        npc.setCustom(n.isCustom());
                    }
                }
            }
        }
