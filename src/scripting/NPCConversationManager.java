...
public class NPCConversationManager extends AbstractPlayerInteraction {
    ...
    public void sendGachaponMega(String name, String msg, Item item, int quantity) {
        World.Broadcast.broadcastGashponmega(MaplePacketCreator.getGachaponMega(name,
                " : x" + quantity + "恭喜玩家 " + c.getPlayer().getName() + " 在" + msg + "获得！", item, (byte) 1,
                c.getPlayer().getClient().getChannel()));
    }
    public void sendGachaponMega(String msg, Item item, int quantity) {
        sendGachaponMega(c.getPlayer().getName(), msg, item, quantity);
    }
