...
public class MaplePacketDecoder extends ByteToMessageDecoder {
    ...
    private static List<Short> ignoreList = Collections.unmodifiableList(Arrays.asList(
            ...
            RecvPacketOpcode.AUTO_AGGRO.getValue(),
            RecvPacketOpcode.MOVE_SUMMON.getValue()
    ));
    public static boolean isSpamHeader_receive(short header) {
        return ignoreList.contains(header);
    }
    @Override
