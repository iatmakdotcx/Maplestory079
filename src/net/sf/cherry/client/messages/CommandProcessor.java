...
import net.sf.cherry.tools.StringUtil;
 ...
 public class CommandProcessor
   implements CommandProcessorMBean
 {
   ...
   public void reloadCommands() {
     ...
     try {
       ...
       for (String clazz : classes) {
         ...
         if (!Command.class.isAssignableFrom(clasz)) continue;
         try {
     ...
     for (File file : scriptFolder.listFiles())
       if ((file.isFile()) && (file.canRead())) {
         ...
         try {
           ...
           compiled.eval();
           Command c = (Command)((Invocable)command).getInterface(Command.class);
           registerCommand(c);
   ...
   public static class PersistingTask
     implements Runnable
   {
     public void run()
     {
