...
public class PlayerInteractionHandler extends AbstractMaplePacketHandler {
    ...
    public enum Action {
        ...
        SKIP(0x3E),
        MOVE_OMOK(0x3F),//小游戏 下棋 或者 翻牌 的动作 ? 完成小游戏(胜利失败)
        SELECT_CARD(0x43);
        /*
         * 39 准备
         * 3B T人
        ...
        if (mode == Action.CREATE.getCode()) {
            ...
            if (createType == 3) {
               ...
               /* if ((createType == 1) || (createType == 2)) {
                    ...
                    if ((!c.getPlayer().getMap().getMapObjectsInRange(c.getPlayer().getPosition(), 19500.0D, Arrays.asList(new MapleMapObjectType[]{MapleMapObjectType.SHOP, MapleMapObjectType.HIRED_MERCHANT})).isEmpty()) || (c.getPlayer().getMapId() < 910000001) || (c.getPlayer().getMapId() > 910000002)) {
           ...
           // byte 未知 = slea.readByte();
            ...
            } else if (((ob instanceof IPlayerInteractionManager))&& (c.getPlayer().getInteraction() == null) && 现金交易 != 6) {
            ...
            /*if ((!c.getPlayer().getMap().getMapObjectsInRange(c.getPlayer().getPosition(), 19500.0D, Arrays.asList(new MapleMapObjectType[]{MapleMapObjectType.SHOP, MapleMapObjectType.HIRED_MERCHANT})).isEmpty()) || (c.getPlayer().getMapId() < 910000001) || (c.getPlayer().getMapId() > 910000022)) {
           ...
           /*  if (item.getItemId() >= 5010000 && item.getItemId() <= 5999999 
            ...
            if ((shop != null) && (shop.isOwner(c.getPlayer())) && (ivItem != null) && (ivItem.getQuantity() >= bundles * perBundle)) {
                if (price < 0) {
