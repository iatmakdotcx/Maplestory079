...
import net.sf.cherry.server.life.MapleLifeFactory.BanishInfo;
...
public class MapleMonster extends AbstractLoadedMapleLife {
    ...
    public int getMaxDrops(MapleCharacter chr) {
        ...
        return maxDrops * chr.hasDropCard();
    }
        ...
        if (!this.getMap().hasEvent()) {
            if (poison) {
                ...
                if (from.getJob() == MapleJob.NIGHTLORD || from.getJob() == MapleJob.SHADOWER) {
                    ...
                    } else if (from.getJob() == MapleJob.SHADOWER||from.getJob() == MapleJob.NIGHT_KNIGHT_3) {
