...
import net.sf.cherry.client.messages.commands.ConsoleCommands;
import net.sf.cherry.net.Constants.ServerConstants;
...
public class ConsoleGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane2.addTab("选项", jPanel1);
        ...
        jTabbedPane2.addTab("信息", jPanel4);
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        if (players.getSize() > 0) {
                    ...
                    for (ChannelServer ch : ChannelServer.getAllInstances()) {
                        for (MapleCharacter chr : ch.getPlayerStorage().getAllCharacters()) {
                            if (jList1.getSelectedValue().equals(chr.getName()) || jList1.getSelectedValue().equals("[GM] " + chr.getName())) {
                                ...
                                System.out.println("删除 " + jList1.getSelectedValue() + "!");
                                loadPlayers();
                            }
                        }
                    }
            ...
            setGMLevel.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent inv) {
                    String input = javax.swing.JOptionPane.showInputDialog(jList1, "输入管理员等级: ");
                    if (input != null) {
                    for (ChannelServer ch : ChannelServer.getAllInstances()) {
                            for (MapleCharacter chr : ch.getPlayerStorage().getAllCharacters()) {
                                if (jList1.getSelectedValue().equals(chr.getName()) || jList1.getSelectedValue().equals("[管理员] " + chr.getName())) {
                                    chr.setGM(Integer.parseInt(input));
                                    chr.getClient().announce(MaplePacketCreator.getCharInfo(chr));
                                    chr.getMap().removePlayer(chr);
                                    chr.getMap().addPlayer(chr);
                                    System.out.println(jList1.getSelectedValue() + " 已设置管理员等级为 " + input + "!");
                                }
                            }
                        }
                    }
                    ...
                    for (ChannelServer ch : ChannelServer.getAllInstances()) {
                        for (MapleCharacter chr : ch.getPlayerStorage().getAllCharacters()) {
                            if (jList1.getSelectedValue().equals(chr.getName()) || jList1.getSelectedValue().equals("[管理员] " + chr.getName())) {
                                ...
                                System.out.println("__________________________________________");
                                System.out.println("管理员等级: " + chr.gmLevel());
                                System.out.println("职业: " + chr.getJob());
                                System.out.println("力量: " + chr.getStr());
                                System.out.println("敏捷: " + chr.getDex());
                                System.out.println("智力: " + chr.getInt());
                                System.out.println("运气: " + chr.getLuk());
                                System.out.println("__________________________________________");
                                System.out.println("                               玩家信息            ");
                                System.out.println("__________________________________________");
                                System.out.println("账号: " + chr.getClient().getAccountName());
                                System.out.println("管理员等级: " + chr.getPlayer().getGMLevel());
                                String ip = chr.getClient().getSession().getRemoteAddress().toString();
                                if(chr.getClient().getGender() == 0){
                                System.out.println("性别: 男");
                                }else{
                                System.out.println("性别: 女");
                                }
                               // System.out.println("性别: " + chr.getClient().getGender());
                                System.out.println("登陆IP: " + ip.substring(1, ip.lastIndexOf(':')));
                            }
                        }
                    }
                }
