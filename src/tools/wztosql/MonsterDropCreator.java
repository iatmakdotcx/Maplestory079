...
public class MonsterDropCreator {
    ...
    public static void getAllMobs() {
        ...
        MapleDataProvider mobData = MapleDataProviderFactory.getDataProvider("Mob.wz");
        ...
        for (MapleData itemFolder : mob.getChildren()) {
            ...
            try {
                ...
                MapleData monsterData = mobData.getData(StringUtil.getLeftPaddedStr(id + ".img", '0', 11));
