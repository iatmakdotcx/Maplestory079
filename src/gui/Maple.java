...
//        //开始读取ini内的参数信息
    ...
    private void initComponents() {
        ...
        刷怪状态 = new javax.swing.JLabel();
        怪物倍率 = new javax.swing.JLabel();
        ...
        jTabbedPane2.addTab("在线玩家", new javax.swing.ImageIcon(getClass().getResource("/image2/信息日志.png")), jPanel5); // NOI18N
...
//                jButton76ActionPerformed(evt);
        ...
        主窗口.addTab("常用工具", new javax.swing.ImageIcon(getClass().getResource("/image2/3994106.png")), 常用工具); // NOI18N
        ...
        刷怪状态.setFont(new java.awt.Font("幼圆", 0, 14)); // NOI18N
        刷怪状态.setText("刷怪状态：关");

        怪物倍率.setFont(new java.awt.Font("幼圆", 0, 14)); // NOI18N
        怪物倍率.setText("怪物倍率：1");
            ...
            .addGroup(jPanel83Layout.createSequentialGroup()
                ...
                .addGroup(jPanel83Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel83Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addGroup(jPanel83Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(刷怪状态, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
                            .addComponent(怪物倍率, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel83Layout.setVerticalGroup(
            ...
            .addGroup(jPanel83Layout.createSequentialGroup()
                ...
                .addGroup(jPanel83Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel83Layout.createSequentialGroup()
                        .addComponent(刷怪状态, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(怪物倍率)))
                .addGap(22, 22, 22))
        );
        ...
        主窗口.addTab("关于", new javax.swing.ImageIcon(getClass().getResource("/image2/关于.png")), 关于我们); // NOI18N
...
//                startserverbutton.setUI(new BEButtonUI().setNormalColor(BEButtonUI.NormalColor.normal));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        JOptionPane.showMessageDialog(null, "也就随便写写你还就信了");
    ...
    private void 传送玩家到指定地图ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_传送玩家到指定地图ActionPerformed
        ...
        if (victim != null) {
            ...
            try
            {
                ...
                JOptionPane.showMessageDialog(null, ee.getMessage(),"传送出错",JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(null, "该玩家不在线上");
        }
    ...
    private void 刷新倍怪地图() {
        String 地图 = ServerProperties.getProperty("server.settings.dMapAddMobMapList");
        倍怪地图.setText("" + 地图 + "");
    }
    
    private void 刷新刷怪状态() {
        String 刷怪状态开关 = ServerProperties.getProperty("server.settings.dMapAddMob");
        刷怪状态.setText("倍怪开关:" + 刷怪状态开关);
    }
    
    private void 刷新倍率状态() {
        String 刷怪倍率显示 = ServerProperties.getProperty("server.settings.dMapAddMobNum");
        怪物倍率.setText("刷怪倍率:" + 刷怪倍率显示);
    }
...
//                            break;
    ...
    private javax.swing.JLabel 刷怪状态;
    ...
    private javax.swing.JLabel 怪物倍率;
