...
public class wzpackage : Dictionary<string, wzpackage>
{
	...
	private bool expand_package(string identity, int offset, int eob, wzproperty proprietor)
	{
		...
		wzproperty wzproperty00 = new wzproperty(identity, type2, this.reader.position, null, proprietor, this.reader);
		proprietor.Add(identity, wzproperty00);
		switch (type2)
		{
		case 0:
			return this.expand_shape2d_Convex2D(offset, eob, wzproperty00);
		case 1:
			return this.expand_shape2d_vector2d(wzproperty00);
		case 2:
			return this.expand_sound_dx8(eob, wzproperty00);
		case 3:
			return this.expand_property(offset, wzproperty00);
		case 4:
			return this.expand_canvas(offset, wzproperty00);
		case 5:
			return this.expand_uol(offset, wzproperty00);
		default:
			return false;
		}
	}
